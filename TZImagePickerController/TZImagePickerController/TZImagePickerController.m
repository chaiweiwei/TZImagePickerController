...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = [UIColor colorWithRed:229/255.0 green:68/255.0 blue:64/255.0 alpha:1];
    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(220/255.0) green:(135/255.0) blue:(135/255.0) alpha:0.5];
    
    self.navigationBar.barTintColor = [UIColor colorWithRed:229/255.0 green:68/255.0 blue:64/255.0 alpha:1];
...
- (void)configDefaultSetting {
    ...
    self.iconThemeColor = [UIColor colorWithRed:229/255.0 green:68/255.0 blue:64/255.0 alpha:1];
